          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form Confirm <small>Confirm Order</small></h2>
                  ...
                  <?php if($cek == 0)
                  {?>
                    <h2 class="text-black text-center">Total Pesanan Masuk Kosong</h2>
                    <br>
                    <h5 class="text-black text-center">Belum Ada Customer yang Melakukan Transaksi</h5>
                    <?php
                  }
                  else
                  {?>
                      ...
                      <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                {?>
                                  <a button type="submit" name ="konfirm" class="btn btn-lg btn-success btn-sm" href="../../confirm.php ?id=<?php echo $row["idcek"];?>">
                                ...
                                ?>
                                <br><br>
                                <a button type="submit" name ="delcek" class="btn btn-lg btn-danger btn-sm" href="../../hapuscek.php ?id=<?php echo $row["idcek"];?>" 
                                onclick="return confirm('Data berdasar ID check out tersebut akan dihapus?')">
