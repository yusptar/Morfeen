          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Morfeen Thirteen <small>Admin</small></h2>
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3  profile_left">
                      ...
                      <br><br>
                      <h3>Morfeen Thirteen Official Store</h3>
                      <br><br>
                      <ul class="list-unstyled user_data">
                        <li><i class="fa fa-map-marker user-profile-icon"><a href="https://www.google.com/maps/place/Jl.+Suwari+Sel.+No.7,+Sukun,+Kec.+Sukun,+Kota+Malang,+Jawa+Timur+65147/@-7.9916457,112.6156626,17z/data=!3m1!4b1!4m5!3m4!1s0x2e7882a7c70f1017:0x40699a3246a09d7d!8m2!3d-7.9916457!4d112.6178513?hl=in">
                      </i> Jl. Suwari Selatan No.7, Sukun, Malang City, East Java</a>
                        </li>

                        <li>
                          <i class="fa fa-briefcase user-profile-icon"></i> Morfeen Store 
                        </li>

                        <li class="m-top-xs">
                          <i class="fa fa-external-link user-profile-icon"></i>
                          <a href="http://www.kimlabs.com/profile/" target="_blank">www.morfeenthirteen.com</a>
                        </li>
                      </ul>
