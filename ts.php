              ...
              <li><a href="all.php">ALL Product</a></li>
                <li class="has-children ">
                  ...
                  <ul class="dropdown">
                    ...
                    <li><a href="ts.php">T-Shirt</a></li>
                    <li><a href="hats.php">Hats</a></li>
                    <li><a href="tottebag.php">TotteBag</a></li>
      ...
      <div class="container">
        ...
        <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/g2.jpeg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">Blue T-SHirt Polo</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">Black T-Shirt</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/g14.jpeg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">Black T-Shirt</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/g16.jpeg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">Blue T-Shirt</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/g17.jpeg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">Red Strips T-Shirt</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/g18.jpeg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">Black T-Shirt</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">White Black Strips T-Shirt</a></h2>
            <strong class="item-price">Rp. 120.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">T-Shirt Raglan</a></h2>
            <strong class="item-price">Rp. 130.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
