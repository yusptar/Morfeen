      ...
      <div class="container">
        <div class="row">
          <div class="title-section mb-5 col-12">
            <h2 class="text-uppercase">Jacket Products</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            ...
            <h2 class="item-title"><a href="#">Hoodie Jemper</a></h2>
          ...
          <div class="col-lg-4 col-md-6 item-entry mb-4">
            <a href="#" class="product-item md-height bg-gray d-block">
              <img src="images/g6.jpeg" alt="Image" class="img-fluid">
            </a>
            <h2 class="item-title"><a href="#">Black Hoodie</a></h2>
            <strong class="item-price">Rp. 295.000</strong>
            <br><br>
            <button type="button" class="btn btn-success">Add to Cart</button>
          </div>
